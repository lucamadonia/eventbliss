...
function RatingBar({ stars, count, total }: { stars: number; count: number; total: number }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-sm text-muted-foreground w-8 font-['Be_Vietnam_Pro']">{stars}&#9733;</span>
      ...
      <span className="text-sm text-muted-foreground w-8 text-right font-['Be_Vietnam_Pro']">{count}</span>
    </div>
  );
}
  ...
  return (
    <div className={`min-h-screen ${C.surface} text-foreground`}>
      ...
      <div className="relative h-64 md:h-80 w-full overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#cf96ff]/10 via-card to-[#00e3fd]/10 animate-pulse" />
      </div>
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 flex flex-col lg:flex-row gap-8">
        ...
        <div className="hidden lg:block w-[380px] shrink-0">
          <div className="h-[480px] rounded-2xl bg-muted animate-pulse" />
        </div>
      </div>
    </div>
  );
...
function ServiceNotFound() {
  ...
  return (
    <div className={`min-h-screen ${C.surface} text-foreground flex items-center justify-center`}>
      <div className="text-center space-y-4">
        <h1 className="text-3xl font-black font-game">Service nicht gefunden</h1>
        <p className="text-muted-foreground font-['Be_Vietnam_Pro']">
  ...
  return (
    <div className={`min-h-screen ${C.surface} text-foreground`}>
      ...
      <div className="relative h-64 md:h-80 w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#cf96ff]/30 via-card to-[#00e3fd]/20" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-4">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground font-['Be_Vietnam_Pro']">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 flex flex-col lg:flex-row gap-8">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mt-3">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm text-muted-foreground font-['Be_Vietnam_Pro']">
                {s.avg_rating} ({s.review_count} Bewertungen)
              </span>
            </div>
            <span className="text-sm text-muted-foreground font-['Be_Vietnam_Pro']">{s.booking_count} Buchungen</span>
          </div>

          <div className="flex flex-wrap items-center gap-3 mt-4">
            <span className="text-2xl font-black font-game text-foreground">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {(s.duration_minutes ?? 0) > 0 && (
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-['Be_Vietnam_Pro'] bg-card border border-border">
            ...
            >
              {activeTab === "beschreibung" && (
                <div className="space-y-6">
                  <p className="text-muted-foreground leading-relaxed font-['Be_Vietnam_Pro'] text-sm">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {s.requirements.map((r, i) => (
                          <li key={i} className="flex items-start gap-2 text-sm text-muted-foreground font-['Be_Vietnam_Pro']">
              ...
              {activeTab === "inklusive" && (
                <ul className="space-y-3">
                  {s.includes.length === 0 && (
                    <p className="text-muted-foreground font-['Be_Vietnam_Pro'] text-sm">Keine Details verfügbar.</p>
                  )}
              ...
              {activeTab === "bewertungen" && (
                <div className="space-y-6">
                  {s.review_count > 0 ? (
                    ...
                    <p className="text-muted-foreground font-['Be_Vietnam_Pro'] text-sm">
              ...
              {activeTab === "agentur" && (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-sm text-muted-foreground font-['Be_Vietnam_Pro']">{agencyCity}</span>
                  ...
                  <button
                    ...
                    className="mt-4 w-full py-2.5 rounded-xl text-sm font-semibold font-['Be_Vietnam_Pro'] bg-muted border border-border hover:border-[#cf96ff]/30 transition-colors"
                  >
                    Profil ansehen
                  </button>
        ...
        >
          <div className="sticky top-24 bg-card/80 backdrop-blur-xl border border-border rounded-2xl p-6 space-y-5">
            <div>
              <span className="text-3xl font-black font-game">{formatPrice(s.price_cents)} €</span>
              <span className="text-sm text-muted-foreground font-['Be_Vietnam_Pro'] ml-2">
            ...
            {/* Date */}
            <div>
              <label className="block text-xs text-muted-foreground font-['Be_Vietnam_Pro'] mb-1.5">Datum wählen</label>
            ...
            {/* Time */}
            <div>
              <label className="block text-xs text-muted-foreground font-['Be_Vietnam_Pro'] mb-1.5">Uhrzeit</label>
              <select
                value={selectedTime}
                onChange={(e) => setSelectedTime(e.target.value)}
                className="w-full px-4 py-3 rounded-xl bg-muted border border-border text-sm font-['Be_Vietnam_Pro'] text-foreground focus:outline-none focus:border-[#cf96ff]/40 transition-colors appearance-none"
              >
            ...
            {s.price_type === "per_person" && (
              <div>
                <label className="block text-xs text-muted-foreground font-['Be_Vietnam_Pro'] mb-1.5">Teilnehmer</label>
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => setParticipants((p) => Math.max(s.min_participants || 1, p - 1))}
                    className="w-10 h-10 rounded-xl bg-muted border border-border flex items-center justify-center hover:border-[#cf96ff]/30 transition-colors"
                  >
                    <Minus size={16} />
                  </button>
                  <div className="flex-1 text-center">
                    <span className="text-xl font-bold font-game">{participants}</span>
                    <span className="text-xs text-muted-foreground font-['Be_Vietnam_Pro'] ml-1.5">
            ...
            {s.payment_method === "on_site" ? (
              ...
              <div className="flex items-center gap-1.5 text-[11px] font-['Be_Vietnam_Pro'] text-muted-foreground">
                <Lock size={12} />
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-sm font-['Be_Vietnam_Pro'] bg-muted border border-border hover:border-[#cf96ff]/30 transition-colors flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl text-sm font-['Be_Vietnam_Pro'] border transition-colors flex items-center justify-center gap-2 ${
                  liked
                    ...
                    : "bg-muted border-border hover:border-pink-500/30"
                }`}
              >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-card/95 backdrop-blur-xl border-t border-border px-4 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-colors ${
              liked ? "bg-pink-500/10 border-pink-500/30 text-pink-400" : "bg-muted border-border"
            }`}
          >
      ...
      <Sheet open={mobileBookingOpen} onOpenChange={setMobileBookingOpen}>
        <SheetContent
          side="bottom"
          className="lg:hidden bg-card border-t border-border text-foreground p-0 max-h-[90vh] rounded-t-2xl"
        >
          <div className="flex flex-col max-h-[90vh]">
            <SheetHeader className="px-5 pt-5 pb-2 text-left">
              <SheetTitle className="text-base font-bold font-game text-foreground">
                {s.title}
              </SheetTitle>
              <div className="flex items-center gap-2 text-xs text-muted-foreground font-['Be_Vietnam_Pro']">
                <span className="font-semibold text-foreground">{formatPrice(s.price_cents)} €</span>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
                      onClick={() => setParticipants((p) => Math.max(s.min_participants || 1, p - 1))}
                      className="w-11 h-11 rounded-xl bg-muted border border-border flex items-center justify-center cursor-pointer active:scale-95 transition-transform"
