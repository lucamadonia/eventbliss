...
const TIER_BADGES: Record<string, { label: string; color: string }> = {
  starter: { label: "Starter", color: "text-gray-400 bg-gray-400/10" },
  professional: { label: "Professional", color: "text-[#cf96ff] bg-[#cf96ff]/10" },
  premium: { label: "Premium", color: "text-[#00e3fd] bg-[#00e3fd]/10" },
};
  ...
  return (
    <div className={`min-h-screen ${C.surface} text-white`}>
      ...
      <div className="relative h-48 w-full overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#cf96ff]/25 via-[#1f1f29] to-[#00e3fd]/15" />
        ...
        >
          ...
          <div className="flex-1 pb-1">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {a.verified && (
                <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-400/10 text-emerald-400 text-xs font-semibold font-['Be_Vietnam_Pro']">
