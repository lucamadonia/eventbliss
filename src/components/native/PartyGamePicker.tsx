...
const GAMES: GameMeta[] = [
  ...
  { id: "pantomime",       nameKey: "native.gameNames.pantomime",       descKey: "native.gameDescs.pantomime",       image: "/images/games/pantomime.webp",       gradient: "from-amber-400 to-pink-400",        tier: "free",    badge: "Neu" },
];
