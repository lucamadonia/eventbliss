...
export const FACTS: Fact[] = [
  ...
  { statement: 'Kuehe können Treppen hinaufsteigen, aber nicht hinunter.', isTrue: true, explanation: 'Aufgrund ihrer Kniestruktur und ihres Sichtfelds können Kuehe Treppen nicht sicher hinabsteigen.', category: 'Kurioses' },
  ...
  { statement: 'Ein Strauss kann schneller laufen als ein Pferd.', isTrue: true, explanation: 'Strausse können bis zu 70 km/h erreichen, waehrend Pferde maximal 65 km/h schaffen.', category: 'Natur' },
  ...
  { statement: 'Ein Kolibri kann rueckwaerts fliegen.', isTrue: true, explanation: 'Kolibris sind die einzigen Voegel, die tatsaechlich rueckwaerts fliegen können.', category: 'Natur' },
...
export const THREE_STATEMENTS: ThreeStatements[] = [
  ...
  },
  {
    statements: [
      ...
      'Chamaeleons können sich voellig unsichtbar machen.',
