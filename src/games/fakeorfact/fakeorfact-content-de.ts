...
export const FACTS: Fact[] = [
  ...
  { statement: 'Kuehe haben vier Maegen.', isTrue: true, explanation: 'Kuehe haben tatsaechlich vier Maegenabschnitte: Pansen, Netzmagen, Blaettermagen und Labmagen.', category: 'Natur' },
  { statement: 'Ein Strauss kann schneller laufen als ein Pferd.', isTrue: true, explanation: 'Strausse koennen bis zu 70 km/h erreichen, waehrend Pferde maximal 65 km/h schaffen.', category: 'Natur' },
  ...
  { statement: 'Venedig hat mehr Bruecken als Amsterdam.', isTrue: false, explanation: 'Amsterdam hat ueber 1.500 Bruecken, Venedig nur etwa 400.', category: 'Geografie' },
  { statement: 'Der Amazonas muendet ins Meer ohne eine einzige Bruecke.', isTrue: true, explanation: 'Es gibt keine Bruecke ueber den gesamten Amazonas — er fliesst durch zu dichten Regenwald.', category: 'Geografie' },
  { statement: 'Bienen koennen Gesichter erkennen.', isTrue: true, explanation: 'Studien zeigen, dass Honigbienen menschliche Gesichter unterscheiden und wiedererkennen koennen.', category: 'Natur' },
  { statement: 'Der Mars hat den hoechsten Berg im Sonnensystem.', isTrue: true, explanation: 'Olympus Mons auf dem Mars ist mit etwa 22 km der hoechste bekannte Berg im Sonnensystem.', category: 'Wissenschaft' },
  { statement: 'Schokolade ist fuer Hunde giftig.', isTrue: true, explanation: 'Theobromin in Schokolade kann fuer Hunde toedlich sein, da sie es nicht abbauen koennen.', category: 'Natur' },
  ...
  { statement: 'Der Vatikan hat die hoechste Kriminalitaetsrate der Welt pro Kopf.', isTrue: true, explanation: 'Da der Vatikan nur etwa 800 Einwohner hat, fuehren wenige Straftaten zu einer hohen Pro-Kopf-Rate.', category: 'Kurioses' },
  { statement: 'Ein Mensch kann im Weltraum ueberleben, wenn er die Luft anhaelt.', isTrue: false, explanation: 'Im Vakuum wuerde die Luft aus den Lungen gewaltsam herausgezogen. Man wuerde ca. 15 Sekunden bewusstlos.', category: 'Wissenschaft' },
  { statement: 'Papier kann maximal 7 Mal gefaltet werden.', isTrue: false, explanation: 'Obwohl es schwierig ist, wurde Papier bereits 12 Mal gefaltet (mit ausreichend grossem Blatt).', category: 'Kurioses' },
  { statement: 'Die Grosse Mauer Chinas ist ueber 21.000 km lang.', isTrue: true, explanation: 'Mit allen Nebenmauern und Verzweigungen misst sie insgesamt 21.196 km.', category: 'Geschichte' },
  ...
  { statement: 'Ein Blauwal-Herz ist so gross wie ein Kleinwagen.', isTrue: true, explanation: 'Das Herz eines Blauwals kann bis zu 600 kg wiegen und ist so gross wie ein VW Kaefer.', category: 'Natur' },
  ...
  { statement: 'Fische koennen ertrinken.', isTrue: true, explanation: 'Wenn zu wenig Sauerstoff im Wasser ist, koennen Fische tatsaechlich ersticken.', category: 'Natur' },
  ...
  { statement: 'Ein Kolibri kann rueckwaerts fliegen.', isTrue: true, explanation: 'Kolibris sind die einzigen Voegel, die tatsaechlich rueckwaerts fliegen koennen.', category: 'Natur' },
  { statement: 'Die Nase waechst das ganze Leben lang.', isTrue: true, explanation: 'Nase und Ohren hoeren nie auf zu wachsen, da sie aus Knorpel bestehen.', category: 'Wissenschaft' },
  ...
  { statement: 'Es gibt mehr Baeume auf der Erde als Sterne in der Milchstrasse.', isTrue: true, explanation: 'Es gibt etwa 3 Billionen Baeume auf der Erde, aber nur 100-400 Milliarden Sterne in der Milchstrasse.', category: 'Natur' },
  ...
  { statement: 'Bananen sind radioaktiv.', isTrue: true, explanation: 'Bananen enthalten Kalium-40, ein radioaktives Isotop. Die Strahlung ist aber voellig harmlos.', category: 'Wissenschaft' },
  ...
  { statement: 'Lachen ist ansteckend, weil das Gehirn Spiegelneuronen aktiviert.', isTrue: true, explanation: 'Spiegelneuronen im Gehirn reagieren auf das Lachen anderer und loesen aehnliche Reaktionen aus.', category: 'Wissenschaft' },
  { statement: 'Russland hat eine groessere Flaeche als Pluto.', isTrue: true, explanation: 'Russland hat 17,1 Mio. km², die Oberflaeche von Pluto betraegt nur 16,7 Mio. km².', category: 'Geografie' },
  ...
  { statement: 'In Norwegen gibt es eine Stadt namens "Hell".', isTrue: true, explanation: 'Hell ist ein Ort in der Gemeinde Verdal in Norwegen. Im Winter friert Hell regelmaessig zu.', category: 'Geografie' },
  { statement: 'Ameisen koennen schwimmen.', isTrue: true, explanation: 'Die meisten Ameisenarten koennen schwimmen und erzeugen kleine Floesse bei Hochwasser.', category: 'Natur' },
  ...
  { statement: 'Ein Chamäleon aendert seine Farbe zur Tarnung.', isTrue: false, explanation: 'Chamaeleons aendern ihre Farbe hauptsaechlich zur Kommunikation und Temperaturregulierung, nicht zur Tarnung.', category: 'Natur' },
  ...
  { statement: 'Spinnen koennen fliegen.', isTrue: true, explanation: 'Manche Spinnen nutzen "Ballooning" — sie lassen sich an Seidenfaeden vom Wind tragen.', category: 'Natur' },
  ...
  { statement: 'Ein Pinguin kann hoeher springen als ein Haus.', isTrue: true, explanation: 'Das ist ein Scherzfakt — Haeuser koennen gar nicht springen, also gewinnt der Pinguin.', category: 'Kurioses' },
];
...
export const THREE_STATEMENTS: ThreeStatements[] = [
  ...
  },
  {
    statements: [
      ...
      'Chamaeleons koennen sich voellig unsichtbar machen.',
      'Chamaeleons leben nur in Afrika.',
    ],
    trueIndex: 0,
    category: 'Tiere',
  },
  {
    statements: [
      ...
      'Der aelteste bekannte Kaugummi ist ueber 5.000 Jahre alt.',
    ],
    trueIndex: 2,
    category: 'Geschichte',
  },
  {
    statements: [
      ...
      'Venedig hat ueber 400 Bruecken.',
      'In Venedig gibt es keine Autos und keine Strassen.',
    ],
    trueIndex: 1,
    category: 'Geografie',
  },
  {
    statements: [
      ...
      'Reis ist das am laengsten haltbare Nahrungsmittel.',
    ],
    trueIndex: 0,
    category: 'Essen',
  },
  ...
  {
    statements: [
      'Elefanten koennen nicht schwimmen.',
