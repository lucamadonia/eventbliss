...
export const FACTS: Fact[] = [
  ...
  { statement: 'Koalas trinken kein Wasser.', isTrue: false, explanation: 'Koalas trinken selten Wasser, da sie Feuchtigkeit aus Eukalyptusblättern beziehen, aber bei Hitze trinken sie durchaus.', category: 'Natur' },
  { statement: 'Schmetterlinge schmecken mit ihren Füßen.', isTrue: true, explanation: 'Schmetterlinge haben Geschmacksrezeptoren an ihren Füßen, um Pflanzen zu identifizieren.', category: 'Natur' },
  ...
  { statement: 'Glas ist eine Flüssigkeit.', isTrue: false, explanation: 'Glas ist ein amorpher Feststoff. Der Mythos von fließendem Glas in alten Fenstern ist falsch.', category: 'Wissenschaft' },
  { statement: 'Ein Tag auf der Venus ist länger als ein Jahr auf der Venus.', isTrue: true, explanation: 'Eine Rotation dauert 243 Erdtage, eine Umrundung der Sonne nur 225 Erdtage.', category: 'Wissenschaft' },
  ...
  { statement: 'Diamanten entstehen aus Kohle.', isTrue: false, explanation: 'Diamanten entstehen aus Kohlenstoff unter extremem Druck, aber nicht aus Kohle — die meisten sind älter als Pflanzen auf der Erde.', category: 'Wissenschaft' },
  ...
  { statement: 'Der menschliche Körper hat mehr Bakterien als eigene Zellen.', isTrue: true, explanation: 'Schätzungen zufolge hat der Körper etwa 38 Billionen Bakterien bei 30 Billionen eigenen Zellen.', category: 'Wissenschaft' },
  { statement: 'Wasser leitet Strom.', isTrue: false, explanation: 'Reines Wasser leitet keinen Strom. Erst die darin gelösten Mineralien und Salze machen es leitfähig.', category: 'Wissenschaft' },

  // Geschichte
  { statement: 'Kleopatra lebte näher an der Mondlandung als am Bau der Pyramiden.', isTrue: true, explanation: 'Die Pyramiden wurden ca. 2560 v.Chr. gebaut, Kleopatra lebte 69-30 v.Chr., die Mondlandung war 1969.', category: 'Geschichte' },
  ...
  { statement: 'Die Chinesische Mauer ist vom Mond aus sichtbar.', isTrue: false, explanation: 'Astronauten bestätigen, dass die Mauer vom Mond aus nicht sichtbar ist — sie ist zu schmal.', category: 'Geschichte' },
  { statement: 'Oxford University ist älter als das Aztekenreich.', isTrue: true, explanation: 'Oxford wurde ab 1096 gegründet, das Aztekenreich erst 1428.', category: 'Geschichte' },
  { statement: 'Wikinger trugen Helme mit Hörnern.', isTrue: false, explanation: 'Archäologische Funde zeigen einfache Helme ohne Hoerner. Das Klischee stammt aus dem 19. Jahrhundert.', category: 'Geschichte' },
  ...
  { statement: 'Spaghetti mit Tomatensosse ist ein traditionelles italienisches Gericht.', isTrue: false, explanation: 'Tomaten kamen erst im 16. Jahrhundert aus Amerika nach Europa. Traditionelle Pasta war anders gewürzt.', category: 'Geschichte' },
  ...
  { statement: 'Island hat keine Muecken.', isTrue: true, explanation: 'Island ist tatsächlich eines der wenigen Länder weltweit ohne heimische Mueckenarten.', category: 'Geografie' },
  ...
  { statement: 'Es gibt mehr Sterne im Universum als Sandkoerner auf der Erde.', isTrue: true, explanation: 'Schätzungen: ca. 10^24 Sterne im beobachtbaren Universum, ca. 7.5×10^18 Sandkoerner.', category: 'Kurioses' },
  ...
  { statement: 'Der Eiffelturm ist im Winter kleiner als im Sommer.', isTrue: true, explanation: 'Durch die Kälte zieht sich das Metall zusammen, wodurch der Turm bis zu 15 cm schrumpft.', category: 'Kurioses' },
  { statement: 'Kühe haben vier Maegen.', isTrue: true, explanation: 'Kühe haben tatsächlich vier Maegenabschnitte: Pansen, Netzmagen, Blaettermagen und Labmagen.', category: 'Natur' },
  ...
  { statement: 'Die Erde dreht sich schneller als vor einer Million Jahren.', isTrue: false, explanation: 'Die Erde dreht sich langsamer. Durch die Gezeitenkraefte des Mondes werden die Tage länger.', category: 'Wissenschaft' },
  ...
  { statement: 'Das Herz einer Garnele sitzt im Kopf.', isTrue: true, explanation: 'Das Herz einer Garnele befindet sich tatsächlich in ihrem Kopf.', category: 'Natur' },
  ...
  { statement: 'Fische können ertrinken.', isTrue: true, explanation: 'Wenn zu wenig Sauerstoff im Wasser ist, können Fische tatsächlich ersticken.', category: 'Natur' },
  ...
  { statement: 'Ein Kolibri kann rückwärts fliegen.', isTrue: true, explanation: 'Kolibris sind die einzigen Vögel, die tatsächlich rückwärts fliegen können.', category: 'Natur' },
  ...
  { statement: 'In Japan ist es ueblich, in der Badewanne zu essen.', isTrue: false, explanation: 'In Japan wird das Bad als Ort der Reinigung betrachtet. Essen darin wäre unueblich.', category: 'Kurioses' },
  { statement: 'Der menschliche Magen produziert taeglich etwa 2 Liter Salzsaeure.', isTrue: true, explanation: 'Die Magensaeure ist stark genug, um Metall aufzulösen, wird aber durch Schleimhaut geschuetzt.', category: 'Wissenschaft' },
  ...
  { statement: 'Ein Tag auf dem Pluto dauert länger als eine Woche auf der Erde.', isTrue: true, explanation: 'Ein Pluto-Tag dauert 6,4 Erdtage — also fast eine ganze Erdwoche.', category: 'Wissenschaft' },
  ...
  { statement: 'Lachen ist ansteckend, weil das Gehirn Spiegelneuronen aktiviert.', isTrue: true, explanation: 'Spiegelneuronen im Gehirn reagieren auf das Lachen anderer und lösen ähnliche Reaktionen aus.', category: 'Wissenschaft' },
  { statement: 'Russland hat eine größere Fläche als Pluto.', isTrue: true, explanation: 'Russland hat 17,1 Mio. km², die Oberfläche von Pluto betraegt nur 16,7 Mio. km².', category: 'Geografie' },
  { statement: 'Ein Teelöffel voll Neutronenstern-Material wiegt 6 Milliarden Tonnen.', isTrue: true, explanation: 'Neutronensterne sind so dicht, dass ein Teelöffel ihres Materials Milliarden Tonnen wiegt.', category: 'Wissenschaft' },
  ...
  { statement: 'Der Mensch teilt 60% seiner DNA mit einer Banane.', isTrue: true, explanation: 'Menschen und Bananen teilen tatsächlich etwa 60% identischer Gene.', category: 'Wissenschaft' },
  ...
  { statement: 'Oxford University existierte vor dem Aztekenreich und vor dem Bau von Machu Picchu.', isTrue: true, explanation: 'Oxford begann ab 1096, das Aztekenreich wurde 1428 gegründet, Machu Picchu um 1450 gebaut.', category: 'Geschichte' },
  { statement: 'Ein Chamäleon ändert seine Farbe zur Tarnung.', isTrue: false, explanation: 'Chamäleons ändern ihre Farbe hauptsaechlich zur Kommunikation und Temperaturregulierung, nicht zur Tarnung.', category: 'Natur' },
  ...
  { statement: 'Ein Pinguin kann höher springen als ein Haus.', isTrue: true, explanation: 'Das ist ein Scherzfakt — Haeuser können gar nicht springen, also gewinnt der Pinguin.', category: 'Kurioses' },
];

export const THREE_STATEMENTS: ThreeStatements[] = [
  {
    statements: [
      'Ein Mensch produziert in seinem Leben genug Speichel, um zwei Schwimmbecken zu füllen.',
  ...
  },
  {
    statements: [
      ...
      'Ein Teelöffel Neutronenstern wiegt ca. 6 Milliarden Tonnen.',
      'Mars hat zwei Monde, die beide größer als unser Mond sind.',
    ],
    trueIndex: 1,
    category: 'Weltraum',
  },
  {
    statements: [
      'Coca-Cola war ursprünglich gruen.',
  ...
  },
  {
    statements: [
      ...
      'Die Roemer benutzten bereits Zahnbürsten aus Schweineborsten.',
  ...
  {
    statements: [
      'Ein Chamäleon kann jedes Auge unabhängig bewegen.',
  ...
  },
  {
    statements: [
      ...
      'Der Mars war früher heißer als die Venus.',
    ],
    trueIndex: 1,
    category: 'Weltraum',
  },
  {
    statements: [
      'Jeder Mensch hat einzigartige Zungenabdrücke.',
      'Der Fingerabdruck ändert sich alle 10 Jahre.',
      'Zwillinge haben immer identische Fingerabdrücke.',
    ],
    trueIndex: 0,
    category: 'Körper',
  },
  ...
  {
    statements: [
      'Die Berliner Mauer stand länger als sie existierte.',
