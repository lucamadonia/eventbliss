...
export const EMOJI_PUZZLES: EmojiPuzzle[] = [
  ...
  { emojis: '🙈🙉🙊', answer: 'Nichts sehen nichts hören nichts sagen', category: 'Sprichwörter', difficulty: 1 },
  ...
  { emojis: '🧪⏰🚗💨', answer: 'Zurück in die Zukunft', category: 'Filme', difficulty: 2 },
  ...
  { emojis: '🎯🔨💪', answer: 'Übung macht den Meister', category: 'Sprichwörter', difficulty: 1 },
